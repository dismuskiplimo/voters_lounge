...
<div class = "container">
	<div class = "row px10top">
		<div class = "col-lg-4">
			...
			<form action = "edit_voter.php?adm=<?php echo $admission?>" method = "post" enctype = "multipart/form-data">
		...
		<div class = "col-lg-8">
			<div class = "row" style = "padding:0px; border-radius:3px; border:1px solid #3C967C; background-color:rgba(60,150,124,0.3);">
				<form action = "edit_voter.php?adm=<?php echo $admission;?>" method = "post" class = "navbar-form" enctype = "multipart/form-data">
					<div class = "col-lg-12">
